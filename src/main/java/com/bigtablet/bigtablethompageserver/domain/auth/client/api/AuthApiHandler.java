...
import com.bigtablet.bigtablethompageserver.domain.auth.client.dto.request.EmailCheckRequest;
import com.bigtablet.bigtablethompageserver.domain.auth.client.dto.request.EmailSendRequest;
...
public class AuthApiHandler {
    ...
    /**
     * 이메일 전송 API
     * @param request EmailSendRequest email
     * @return status, message
     */
    @PostMapping("/email")
    ...
    /**
     * 인증번호 확인 API
     * @param request EmailCheckRequest email, authCode
     * @return status, message
     */
